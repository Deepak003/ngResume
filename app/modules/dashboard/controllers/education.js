...
function ($rootScope, $scope, $state, $location, dashboardService, Flash) {
    ...
    vm.education = [
        
        {
            ...
            institution: "M.J.P Rohilkhand University,Bareilly,U.P",
            board: "Deemed University",
            theme: "warning",
            icon: "graduation‐cap ",
            mark: 7.1,
            max: 10
        },
        {
            ...
            year: "2001 - 2002",
            title: "+2",
            institution: "St. Fidelis College,Lucknow,U.P.",
            board: "I.S.C",
            theme: "danger",
            icon: "pencil",
            mark: 75,
        ...
        datasets: [
            {
                ...
                pointHighlightFill: "#fff",
                pointHighlightStroke: "rgba(220,220,220,1)",
                data: [7.7, 7.8, 8.5, 8.1,8.1,10.0,7.8,8.3]
            }
        ]
    };

    vm.hscData = {
        labels: ["Hindi", "English", "Maths", "Physics", "Chemistry", "Computer Science"],
        datasets: [
            {
                label: "My HSC Marks",
